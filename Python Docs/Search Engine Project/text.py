...
class TextProcessor:
    ...
    def processFile(self, filename):
        ...
        return doc_set
Posted by vkedco at 11:05 AM
Labels: computer science education, computer science, information retrieval, IR, object-oriented programming, OOP, python, python programming, search engine, vladimir kulyukin 